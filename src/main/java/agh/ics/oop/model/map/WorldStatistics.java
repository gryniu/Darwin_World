...
import agh.ics.oop.model.animal.Gen;
import agh.ics.oop.model.map.utils.EnergyPercentiles;
...
public class WorldStatistics {
    ...
    private int getEnergyPercentile(int percentile) {
    ...
    public MapStats getMapStats(){
        return new MapStats(worldMap.getAnimalsCount(), worldMap.getPlantsCount(), worldMap.getFreeFieldsCount(), getAverageEnergy(), getAverageLifespan(), getAverageChildren(), getMostPopularGenotype(), new EnergyPercentiles(getEnergyPercentile(50), getEnergyPercentile(85)));
    }
